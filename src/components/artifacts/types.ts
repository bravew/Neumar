...
export interface Artifact {
  ...
  // Flag indicating the artifact is a final deliverable (video, audio, document, etc.)
  isOutput?: boolean;
  // Optional run metadata used to group generated outputs with their inputs.
  runId?: string;
  sourceToolCallId?: string;
  isSourceAttachment?: boolean;
}

/** Content-only artifact types that are commonly final deliverables. */
export const OUTPUT_ARTIFACT_TYPES = new Set<ArtifactType>([
  'image',
  'video',
  'audio',
  'pdf',
