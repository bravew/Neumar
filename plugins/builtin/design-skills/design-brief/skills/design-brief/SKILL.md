...
If the project prompt names an active chat language or locale, write every
discovery/intake form title, description, question label, option label, helper
text, validation message, and placeholder in that language. Treat English
examples in this skill as structure examples, not text to copy.
