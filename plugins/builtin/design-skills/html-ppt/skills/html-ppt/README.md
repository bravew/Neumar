...
> "Make an 8-page technical sharing deck with a cyberpunk theme"
> "turn this outline into a pitch deck"
> "Create a 9-page social carousel with a soft white editorial look"
...
**Extracted looks**
- `xhs-white-editorial` — white editorial social style
- `graphify-dark-graph` — dark force-directed knowledge graph
- `knowledge-arch-blueprint` — blueprint / architecture style
- `hermes-cyber-terminal` — terminal cyberpunk style
- `obsidian-claude-gradient` — purple gradient cards
- `testing-safety-alert` — red / amber alert style
- `xhs-pastel-card` — soft pastel carousel style
