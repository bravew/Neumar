...
<div class="hint-bar">
  ...
  <span style="color:#6e7681">Drag a card header to move it · drag the bottom-right corner to resize it</span>
...
(function(){
  ...
  function update(n) {
    ...
    notesBody.innerHTML = note || '<span class="empty">(This slide has no speaker notes yet)</span>';
  ...
  notesBody.innerHTML = slideMeta[idx].notes || '<span class="empty">(This slide has no speaker notes yet)</span>';
